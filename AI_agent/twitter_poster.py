...
#         "pWG2G0kSCU2m8kAyXkUdHR9wr", "9H61nxau3s0YM4gqlRbfW3CVtTmgYGrwwDDEg9ksNwbOQyMxaN", "1459878913593729025-JdY7WHi4TdjfeMKigAebNWn0ptgAgQ", "l7lMk9wQD3gfelIytnbBn3bOmdZux2QtgKNeWdoEUumrw"
#     )
#     api = tweepy.API(auth)
#     if image_path:
